...
//  => admin 을 제외한 전체 member count 메서드 추가 Test
//  => MemberMapper interface에 등록해야 함
    ...
    // MemberMapper.java에 selectList2추가 후 Test
    // Mapper interface의 메서드명 위에 @을 이용하여 sql 구문 작성
    // @ select("select * from member where lev = 'D'")
    // @ select : mapper 없이 일반 쿼리문을 작성해서 사용할 수 있도록 해줌
    public void selectList2() {
    	System.out.println(" @select Test =>" + mapper.selecrList2());
    }
