...
<body>
	...
	<form action="binsert" method="post">
		...
		<table>
			...
			<tr height="40">
				<td bgcolor="MediumVioletRed">I D</td>
				<td><input type="text" name="id" value="${loginID}" size="20"
					readonly></td>
			</tr>
			<tr height="40">
				<td bgcolor="MediumVioletRed">Title</td>
				<td><input type="text" name="title" placeholder="반드시 입력하세요."></td>
			</tr>
			<tr height="40">
				<td bgcolor="MediumVioletRed">Content</td>
